...
class TranslatorActions{
    ...
    public:
    uint16_t create_flag(bool left, bool right, bool up, bool down, bool stop_right, bool stop_left, bool jump, bool stop_jump, bool press_action_button, bool unpress_action_button, bool press_pick_up_button, bool unpress_pick_up_button){
    ...
    void translate_flags(const uint16_t action, bool& left, bool& right, bool& up, bool& down,
                    bool& stop_right, bool& stop_left, bool& jump, bool& stop_jump, bool& press_action_button, bool& unpress_action_button, bool& press_pick_up_button, bool& unpress_pick_up_button){    
        left        = action & LEFT;
        right       = action & RIGHT;
        up          = action & UP;
        down        = action & DOWN;
