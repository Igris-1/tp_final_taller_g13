#include "bullet_interface.h"
 ...
 BulletInterface::BulletInterface(int duck_trigger_id, int x, int y, int x_direction, int y_direction): Positionable(x, y, 16, 16), duck_trigger_id(duck_trigger_id){
