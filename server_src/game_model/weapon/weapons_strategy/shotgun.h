...
//          //    bullets.push_back(Pellet(start_position, direction + Position(1,0),
//          TILES_PELLET_DISTANCE));
//          //    bullets.push_back(Pellet(start_position, direction + Position(-1,0),
//          TILES_PELLET_DISTANCE));
//          //    bullets.push_back(Pellet(start_position, direction + Position(-2,0),
//          TILES_PELLET_DISTANCE));
//          //    bullets.push_back(Pellet(start_position, direction + Position(2,0),
//          TILES_PELLET_DISTANCE));
//          //    bullets.push_back(Pellet(start_position, direction + Position(-3,0),
//          TILES_PELLET_DISTANCE));
//          // }
// };
